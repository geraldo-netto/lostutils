...
| rf-di-61 | open | high | medium | relocate_folder.py:1188 — [data integrity] Keep unpinned copy population isolated from destination replacement; dirs_exist_ok=True follows a replacement destination symlink and overwrites unrelated contents. Populate a privately owned tree before publication or use pinned destination access, and cover symlink/directory swaps. |
