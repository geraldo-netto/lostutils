...
|---|---|---|---|---|
| bt-gov-01 | open | medium | low | bookmark-tidy.py:927 — [data governance] Redact URL userinfo before logging a mutable duplicate; the current INFO line exposes credentials embedded in `user:password@host`. |
